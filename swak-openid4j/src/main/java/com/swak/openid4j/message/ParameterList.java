...
public class ParameterList implements Serializable {
    ...
    public ParameterList() {
        ...
        if (DEBUG) log.debug("Created empty parameter list.");
    }

    public ParameterList(ParameterList that) {
        if (DEBUG) log.debug("Cloning parameter list:\n" + that);
    ...
    public ParameterList(Map parameterMap) {
        ...
        while (keysIter.hasNext()) {
            ...
            if (v instanceof String[]) {
                ...
                value = "";
                log.error("Can extract parameter value; unexpected type: " +
                        v.getClass().getName());
            }
        ...
        if (DEBUG) log.debug("Creating parameter list:\n" + this);
    }

    public void copyOf(ParameterList that) {
        if (DEBUG) log.debug("Copying parameter list:\n" + that);
    ...
    public static ParameterList createFromQueryString(String queryString) throws MessageException {
        if (DEBUG) log.debug("Creating parameter list from query string: " + queryString);
    ...
    public static ParameterList createFromKeyValueForm(String keyValueForm) throws MessageException {
        if (DEBUG) log.debug("Creating parameter list from key-value form:\n" + keyValueForm);
