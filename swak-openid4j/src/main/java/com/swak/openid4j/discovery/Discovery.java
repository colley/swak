...
import com.swak.openid4j.discovery.html.HtmlResolver;
import com.swak.openid4j.discovery.xri.XriResolver;
...
import com.swak.openid4j.util.OpenID4jUtils;
...
public class Discovery {
    ...
    public static XriResolver getXriResolver() {
        String className = OpenID4jUtils.getProperty(XRI_RESOLVER_CLASS_NAME_KEY);
