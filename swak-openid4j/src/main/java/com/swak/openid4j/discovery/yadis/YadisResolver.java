...
public class YadisResolver {
    ...
    static {
        String className = OpenID4jUtils.getProperty(YADIS_HTML_PARSER_CLASS_NAME_KEY);
        ...
        className = OpenID4jUtils.getProperty(XRDS_PARSER_CLASS_NAME_KEY);
     ...
     * @param serviceTypes The HttpClient object to use for placing the call
     * @param maxRedirects
     */
     ...
     *
     * @param serviceTypes HttpClient object to use for placing the call
     * @param maxRedirects
     * @param url          The YadisURL
     * @param useGet       The location of the XRDS document and the normalized
