...
public class ServerManager {
     ...
     * per message basis.
     *
     * @see #authResponse(com.swak.openid4j.message.ParameterList, String, String, boolean, String)
     */
     ...
     * @see #authResponse(com.swak.openid4j.message.ParameterList, String, String,
     ...
     * or an IndirectError / DirectError message.
     * @see #authResponse(com.swak.openid4j.message.AuthRequest, String, String,
     * boolean, String, boolean)
     */
