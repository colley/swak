...
public class SunThread {
    ...
    public String toString() {
        return "SunThread [id=" + id + ", name=" + name + ", state=" + state + ", deadlocked="
            + deadlocked + ", suspended=" + suspended + ", inNative=" + inNative + ", lockName="
            + lockName + ", lockOwnerName=" + lockOwnerName + ", waitedCount=" + waitedCount
            + ", blockedCount=" + blockedCount + ", executionPoint=" + executionPoint + "]";
    }
